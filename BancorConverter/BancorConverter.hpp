...
*/
class [[eosio::contract("BancorConverter")]] BancorConverter : public eosio::contract {
   // using contract::contract;
    public:
    BancorConverter(name receiver, name code,  datastream<const char*> ds): contract(receiver, code, ds) {}
