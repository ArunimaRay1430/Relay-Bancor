...
*/
class [[eosio::contract("BancorNetwork")]] BancorNetwork : public eosio::contract {
//CONTRACT BancorNetwork : public eosio::contract {
  //  using contract::contract;
    public:
 BancorNetwork(name receiver, name code,  datastream<const char*> ds): contract(receiver, code, ds) {}
